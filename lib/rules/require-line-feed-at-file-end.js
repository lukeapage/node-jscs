...
module.exports.prototype = {
    ...
    _fix: function(file) {
        ...
        var lastToken = file.getLastToken({ includeWhitespace: true });
        if (lastToken.isWhitespace) {
            lastToken.value += linebreak;
        } else {
        }
        file.setWhitespaceAfter(lastToken, new Array(eolCount).join(linebreak) + targetIndent)
    }
};
